...
permalink: /research/textbooks-to-rl/
...
<img src="{{ '/assets/posts/textbooks-to-rl/TRL_diagram.png' | relative_url }}" alt="TRL Diagram" width="400" />
...
![TTL Bar Chart]({{ '/assets/posts/textbooks-to-rl/TTL_bar_image.png' | relative_url }})
